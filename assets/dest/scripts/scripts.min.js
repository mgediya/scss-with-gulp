...
var $=jQuery.noConflict();$(document).ready(function(){$(".hamburger").click(function(s){$(".mbnav").toggleClass("is-open")}),$(".mbnav .mbnav__backdrop").click(function(){$(".mbnav").removeClass("is-open")});var s=$(".menu-state").attr("data-clickable");$(".mbnav li:has(ul)").addClass("has-sub"),$(".mbnav .has-sub>a").after('<em class="mbnav__caret">'),"true"==s?$(".mbnav .has-sub>.mbnav__caret").addClass("trigger-caret"):$(".mbnav .has-sub>a").addClass("trigger-caret").attr("href","javascript:;"),$(".mbnav .has-sub>.trigger-caret").click(function(){var s=$(this).parent("li");s.hasClass("is-open")?(s.removeClass("is-open"),s.find("li").removeClass("is-open"),s.find("ul").slideUp(200)):(s.addClass("is-open"),s.children("ul").slideDown(200),s.siblings("li").children("ul").slideUp(200),s.siblings("li").removeClass("is-open"),s.siblings("li").find("li").removeClass("is-open"),s.siblings("li").find("ul").slideUp(200))})}),$(window).on("load",function(){}),$(window).on("scroll",function(){}),$(window).on("resize",function(){});
